...
Thank you!`;
    ...
    async getAIResponse(userText) {
        ...
        if (isQuestion || isInfoRequest || isServiceQuery) {
            // Handle generic pricing queries
            if (query.includes('price') || query.includes('kitna') || query.includes('cost')) {
                return {
                    text: isEnglish
                        ? "I'd be happy to share the details about your concern! Which service are you interested in?\n\n🏢 **Corporate Events** - Starting from ₹50,000\n💒 **Weddings** - Starting from ₹2,00,000\n🎉 **Celebrations** - Starting from ₹30,000\n🎭 **Entertainment** - Starting from ₹1,00,000\n\nSelect a category to see detailed packages and pricing:"
                        : "Kaunsi service chahiye?\n\n🏢 **Corporate Events** - ₹50,000 se shuru\n💒 **Weddings** - ₹2,00,000 se shuru\n🎉 **Celebrations** - ₹30,000 se shuru\n🎭 **Entertainment** - ₹1,00,000 se shuru\n\nCategory select karein detailed packages ke liye:",
                    quickReplies: ['Wedding', 'Corporate', 'Celebration', 'Entertainment']
                };
            }

            // Handle generic service listing queries
            if (query.includes('kon kon') || query.includes('kya kya') || (query.includes('service') && query.length < 20)) {
                return {
                    text: isEnglish
                        ? "We offer comprehensive event management services across 4 main categories:\n\n🏢 **Corporate Events**\n• Product Launch\n• Conferences\n• Dealers Meet\n• Annual Day\n• Team Building\n\n💒 **Weddings**\n• Destination Wedding\n• Luxury Wedding\n• Traditional Wedding\n• Wedding Decor\n• Pre-Wedding Events\n\n🎉 **Celebrations**\n• Birthday Parties\n• Diwali/Holi/Christmas\n• Theme Parties\n• Anniversaries\n\n🎭 **Entertainment**\n• Live Concerts\n• Fashion Shows\n• Award Nights\n• Carnival Events\n\nSelect a category to learn more!"
                        : "Hum 4 main categories me event management services dete hain:\n\n🏢 **Corporate Events**\n• Product Launch\n• Conferences\n• Dealers Meet\n• Annual Day\n• Team Building\n\n💒 **Weddings**\n• Destination Wedding\n• Luxury Wedding\n• Traditional Wedding\n• Wedding Decor\n• Pre-Wedding Events\n\n🎉 **Celebrations**\n• Birthday Parties\n• Diwali/Holi/Christmas\n• Theme Parties\n• Anniversaries\n\n🎭 **Entertainment**\n• Live Concerts\n• Fashion Shows\n• Award Nights\n• Carnival Events\n\nCategory select karein details ke liye!",
                    quickReplies: ['Wedding', 'Corporate', 'Celebration', 'Entertainment']
                };
            }
